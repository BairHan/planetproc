...
proc.conf           | contains configuration settings for procd or proc-qt
procd.pid           | stores the process id of procd while running
...
debug.log           | contains debug information and general logging generated by procd or proc-qt
