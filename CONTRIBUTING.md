Contributing to PROC Core
============================

The PROC Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/proc-project/proc/blob/master/doc/translation_process.md)
...
The following applies to code changes to the PROC Core project, and is not to be
confused with overall PROC Network Protocol consensus changes.

Whether a pull request is merged into PROC Core rests with the project merge
...
Patches that change PROC consensus rules are considerably more involved than
...
Where a patchset proposes to change the PROC consensus, it must have been
...
The project leader is the release manager for each PROC Core release.
